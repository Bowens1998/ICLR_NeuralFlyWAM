"""Full acceptance gate for the locked Round15 training roster, no inference."""
...
def main():
    ...
    for task in sub["tasks"]:
        ...
        assert (
            ...
            and prov["training_windows"] == 12288
        )
        selected = 0
        best = float("inf")
        for i, r in enumerate(rows):
    ...
    target = Path("runs/evidence/round15_bundle") / (plan["plan_name"] + "_acceptance.json")
